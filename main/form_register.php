...
<body style= "background: url('img/brands/123.jpg') 0 0/cover">
	<?php
	...
	?>
		...
		<div class="container_form">
			...
			<br>
			<em>Ваш пароль должен содержать цифры, буквы, знаки пунктуации, завязку, развитие, кульминацию и неожиданный финал с двумя шутками про хохлов</em>
